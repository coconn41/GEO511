# set wd
setwd("/Users/collinoconnor/Desktop/GEO 511/GEO511wd")
# check wd
getwd()
wd=getwd()
# load tidyr, tidyverse, dplyr, ggplot2 from seperate source script
source(paste(wd,"/R Basic Lib Load.R",sep=""))
#load iris dataset
data(iris)
#view iris dataset
head(iris)
